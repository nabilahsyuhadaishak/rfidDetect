...
<body>
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
        <a href="#" class="navbar-brand"><span class="auto-style2">   RFID TAG DETECTION      </span></a>
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="collapse navbar-collapse" id="navbarMenu">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="Home.aspx" class="nav-link"><span class="auto-style3 glyphicon glyphicon-home"> Home  </span></a>
                </li>
                &nbsp;&nbsp;&nbsp;
                <li class="nav-item">
                    <a href="DatabasePage.aspx" class="nav-link"><span class="auto-style3 glyphicon glyphicon-hdd"> Database  </span></a>
                </li>
            </ul> 
        </div>
    </nav>
